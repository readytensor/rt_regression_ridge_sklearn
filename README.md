...
## Project Description
This repository is a dockerized implementation of the Ridge regressor. It is implemented in flexible way that it can be used with any regression dataset with the use of JSON-formatted data schema file.
...
- A Ridge regressor algorithm built using **SciKit-Learn**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Ridge regressor model implemented using **Scikit-Learn** library.
